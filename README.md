...
- **Learns your library.** Every detected game gets a library entry with cover art, genre, developer, and release year pulled from Steam, IGDB, RAWG, GOG, and SteamGridDB.
...
- **Works across two PCs.** The optional SPARK companion agent runs on a separate gaming PC and forwards detections to StatusForge on your streaming PC.
